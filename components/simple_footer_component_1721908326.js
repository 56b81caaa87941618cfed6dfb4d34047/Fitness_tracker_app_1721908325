...
*/
Vue.component("simple_footer_component_1721908326", {
    template: `
    <footer id="footer-section" style="height: 510px" class="flex-1 bg-white dark:bg-gray-800">
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            FitForce - Your Fitness Companion
                        </a>
                    </div>
                </div>
                <div class="flex">
